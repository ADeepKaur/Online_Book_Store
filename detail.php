										...
										<?php
											...
											echo '	<table border="0" width="100%">
												 ...
												 <tr align="center" height="30px">
													 <td font size="30px BOLD">ITEM DETAILS</td>
												</tr>
												<tr>
													<td><hr color="purple"></td>
												</tr>
											...
											<table border="0" width="100%">
												 ...
												 if(isset($_SESSION['status']))
												 {
													echo ' <td><a href="process_cart.php?nm='.$row['b_nm'].'&cat='.$_GET['cat'].'&rate='.$row['b_price'].'">
														<img src="images/add-to-cart.png" height="52" width="150">
													</a></td>';
												}
												else
												{
													echo '<td><img src="images/add-to-cart.png" height="52" width="150"><br><a href="register.php"> <h4>Please Login or register to proceed</h4></a></td>';
												}
												echo '</tr>
											</table>';
										?>
