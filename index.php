<?php session_start();
	...
	$totalq="select count(*) \"total\" from book where b_price='45'";
						...
						<div class="post">
							...
							<?php 
								if(isset($_SESSION['status']))
								{
									...
									echo '<br><hr><h1>Most Selling Books</ph1>';
								}
								else
								{	
									echo 'Most Selling Books';
								}
							?>
							</h1>
							<div class="entry">
								...
								<table border="0" width="100%" >
											...
											<?php
												...
												$query="select *from book where b_price='45' LIMIT ".$k .",".$page_per_page;
												...
												while($row=mysqli_fetch_assoc($res))
												{
													...
													echo '<td valign="top" width="10%" align="center">
														<a href="detail.php?id='.$row['b_id'].'&cat='.$_GET['subcatnm'].'">
														<img src="'.$row['b_img'].'" width="150" height="200">
														<br>'.$row['b_nm'].'</a>
													</td>';
													$count++;							
